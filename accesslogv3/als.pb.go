...
type StreamAccessLogsMessage struct {
	...
	Identifier *StreamAccessLogsMessage_Identifier `accesslogv3:"bytes,1,opt,name=identifier,proto3" json:"identifier,omitempty"`
...
type StreamAccessLogsMessage_HttpLogs struct {
	HttpLogs *StreamAccessLogsMessage_HTTPAccessLogEntries `accesslogv3:"bytes,2,opt,name=http_logs,json=httpLogs,proto3,oneof"`
}

type StreamAccessLogsMessage_TcpLogs struct {
	TcpLogs *StreamAccessLogsMessage_TCPAccessLogEntries `accesslogv3:"bytes,3,opt,name=tcp_logs,json=tcpLogs,proto3,oneof"`
}
...
type StreamAccessLogsMessage_Identifier struct {
	...
	Node *v3.Node `accesslogv3:"bytes,1,opt,name=node,proto3" json:"node,omitempty"`
	// The friendly name of the log configured in :ref:`CommonGrpcAccessLogConfig
	// <envoy_v3_api_msg_extensions.access_loggers.grpc.v3.CommonGrpcAccessLogConfig>`.
	LogName string `accesslogv3:"bytes,2,opt,name=log_name,json=logName,proto3" json:"log_name,omitempty"`
}
...
type StreamAccessLogsMessage_HTTPAccessLogEntries struct {
	...
	LogEntry []*v31.HTTPAccessLogEntry `accesslogv3:"bytes,1,rep,name=log_entry,json=logEntry,proto3" json:"log_entry,omitempty"`
}
...
type StreamAccessLogsMessage_TCPAccessLogEntries struct {
	...
	LogEntry []*v31.TCPAccessLogEntry `accesslogv3:"bytes,1,rep,name=log_entry,json=logEntry,proto3" json:"log_entry,omitempty"`
}
